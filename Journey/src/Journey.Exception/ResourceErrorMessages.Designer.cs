...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// </summary>
        public static string DATE_TRIP_MUST_ME_LATER_THAN_TODAY {
            get {
                return ResourceManager.GetString("DATE_TRIP_MUST_ME_LATER_THAN_TODAY", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The end date of the trip must be equal to or late than Start Date..
        /// </summary>
